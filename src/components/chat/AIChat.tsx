...
export default function AIChat() {
  ...
  async function handleSubmit(event: React.FormEvent) {
    ...
    try {
      ...
      if (aiResponse.contentType === 'quiz' || aiResponse.contentType === 'ppt' || aiResponse.contentType == 'flashcards'  || aiResponse.contentType == "canvas" || aiResponse.contentType == "image") {
