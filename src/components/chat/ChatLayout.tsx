...
export default function ChatLayout({ chatHistory, userId, messages, chatId }: { chatHistory: Chat[], userId: string, messages?: (O1MessagesInput | GPT4oMessagesInput)[] | undefined, chatId?: string }) {
